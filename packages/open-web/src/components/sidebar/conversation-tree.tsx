...
function ConversationItem({ item, inputDialog, confirmDialog }: ConversationItemProps) {
  ...
  return (
    <div
      className={cn(
        'group flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-gray-100',
    ...
    >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-36">
          <DropdownMenuItem onClick={handleToggleFavorite} className="gap-2 text-sm">
