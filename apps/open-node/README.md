...
- **技术**: Keyv + SQLite
- **文件**: `~/.open-context/leveldb/main.sqlite`, `edges.sqlite`, `reverse-edges.sqlite`
- **用途**: 存储代码符号之间的依赖关系，支持正向和反向边查询
- **优势**:
  - 简单的 key-value 接口
  - SQLite 提供 ACID 事务保证
  - 支持批量操作和前缀查询
